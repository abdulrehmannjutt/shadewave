...
function HomeCards({
  ...
  return (
    <div className="w-full">
      <div className="h-full hover:border rounded overflow-hidden flex flex-col bg-white hover:shadow-lg transition-shadow">
        <img
        ...
        <div className="p-6 bg-white flex flex-col justify-between h-full">
          <div>
            <h1 className="title-font text-[16px] font-semibold text-blackCustom mb-1 text-center">
              {title}
            </h1>
            <div className="flex flex-col justify-center items-center mt-1">
              <p className="leading-relaxed text-greyCustom text-[13px]">
                {category}
              </p>
