...
function ProductsTable() {
  ...
  const [deleteModalForProducts, setDeleteModalForProducts] = useState(false);
  ...
  return (
    <>
      <div className="min-h-screen">
        {/* Start block */}
        <section className="dark:bg-gray-900 p-3 sm:p-5 antialiased min-h-screen">
            ...
            <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
              ...
              {addProduct && (
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 min-h-screen">
                          ...
                          >
                            ...
                            >
                              <div className="flex items-center mr-3">
                                <img
                                  src={`${BACKEND_BASE_URL}admin/image/${product.images[0]}`}
                                  alt="product"
                            ...
                            <td className="px-4 py-3 flex items-center justify-end">
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  dispatch(setSelectedProduct(product));
                                  setDeleteModalForProducts(true);
                                }}
                                type="button"
        ...
        {/* Delete modal */}
        {deleteModalForProducts && (
          <DeleteModal
            url="admin/deleteproduct/"
            setDeleteModalForProducts={setDeleteModalForProducts}
          />
        )}
      </div>
    </>
